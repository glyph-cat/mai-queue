...
const queueListener = new QueueListener('past', (currentArcade) => query(
...
export const usePastQueueConsumer = queueListener.useQueueConsumer
export const usePastQueueProvider = queueListener.useQueueProvider
